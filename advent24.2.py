...
with open("/Users/jonathanborer/Desktop/Programmieren WI/advent/advent_data/day24.txt") as fin:
...
with open("/Users/jonathanborer/Desktop/Programmieren WI/advent/advent_data/day24empty.json") as fin:
    name = json.load(fin)
